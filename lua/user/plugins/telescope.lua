return {
  {
    ...
    config = function()
      ...
      local add_find_files_defaults = function(opts)
        return vim.tbl_extend("force", find_files_default_opts, opts)
      end
      ...
      end, "Show all the diagnostics mesages in the project")
